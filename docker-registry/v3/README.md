...
kind: Kustomization
resources:
  - github.com/utilitywarehouse/system-manifests/docker-registry/v3/base
components:
  - github.com/utilitywarehouse/system-manifests/docker-registry/v3/components/jwks-generator
```
...
The `jwks-generator` script can be found [here](https://github.com/utilitywarehouse/system-manifests/tree/master/docker-registry/v3/components/jwks-generator).
